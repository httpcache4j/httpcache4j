...
public class DefaultAuthenticatorTest {
    ...
    public void testNoAuthExpectTheSameRequest() {
        final HTTPRequest req = new DefaultAuthenticator().prepareAuthentication(defaultRequest, new HTTPResponse(Status.CREATED, new Headers()));
    ...
    public void testAuthBasic() {
        ...
        final HTTPRequest req = new DefaultAuthenticator().prepareAuthentication(request,
                                                                                 new HTTPResponse(Status.UNAUTHORIZED,
