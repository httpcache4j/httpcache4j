...
public class DirectivesTest {
    ...
    public void testSingleDirectiveWithNoValue() {
        Directives dir = DirectivesParser.parse("value");
    ...
    public void testMultipleDirectives() {
        Directives dir = DirectivesParser.parse("key=value,bar=foo, foo=\"bar\"");
    ...
    public void testSingleDirectiveWithQuotedValueWithComma() {
        Directives dir = DirectivesParser.parse("foo=\"bar,baz\",bar=foo");
